...
def model_tester():
    print("--------------------------")
    print("Seed Data for Table: workouts")
    print("--------------------------")
    db.create_all()
    """Tester data for table"""
    u1 = Workouts(name='American Airlines', departingLocation='San Diego SAN', arrivalLocation='Boston BOS',
                 departingTime="8:30 PM", arrivalTime="8:30 PM")
    u2 = Workouts(name='United Airlines', departingLocation='Los Angeles LAX', arrivalLocation='Orlando MCO',
                 departingTime="7:45 PM", arrivalTime="8:30 PM")
    u3 = Workouts(name='Southwest', departingLocation='San Diego SAN', arrivalLocation='San Francisco SFO',
                 departingTime="1:45 PM", arrivalTime="8:30 PM")
    u4 = Workouts(name='Delta', departingLocation='Austin AUS', arrivalLocation='Denver DEN',
                 departingTime="1:30 PM", arrivalTime="8:30 PM")
    u5 = Workouts(name='Alaskan Airlines', departingLocation='Vancouver YVR', arrivalLocation='Seattle SEA',
                 departingTime="2:00 PM", arrivalTime="8:30 PM")
    u6 = Workouts(name='Spirit', departingLocation='New York JFK', arrivalLocation='Tallahassee TLH',
                 departingTime="11:15 AM", arrivalTime="8:30 PM")
    u7 = Workouts(name='Emirates', departingLocation='Dubai DXB', arrivalLocation='Los Angeles LAX',
                 departingTime="10:45 PM", arrivalTime="8:30 PM")
    u8 = Workouts(name='Lufthansa', departingLocation='Berlin BML', arrivalLocation='Munich MUC',
                 departingTime="12:30 PM", arrivalTime="8:30 PM")
    u9 = Workouts(name='Quantas', departingLocation='Sydney SYD', arrivalLocation='Melbourne MEL',
                 departingTime="3:45 PM", arrivalTime="8:30 PM")
    u10 = Workouts(name='British Airways', departingLocation='London LHR', arrivalLocation='Montreal YUL',
                  departingTime="7:00 PM", arrivalTime="8:30 PM")
    u11 = Workouts(name='Swiss Air', departingLocation='Zurich ZRH', arrivalLocation='New York JFK',
                  departingTime="9:30 PM", arrivalTime="8:30 PM")
    u12 = Workouts(name='Air India', departingLocation='New Delhi DEL', arrivalLocation='San Francisco SFO',
...
def model_printer():
    print("------------")
    print("Table: workouts with SQL query")
    print("------------")
