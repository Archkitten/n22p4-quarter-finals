"""control dependencies to support player routes and APIs"""
...
app_player_api = Blueprint('player_api', __name__,
                         url_prefix='/player_api',
                         template_folder='templates/player/',
                         static_folder='static',
                         static_url_path='static')

# API generator https://flask-restful.readthedocs.io/en/latest/api.html#id1
api = Api(app_player_api)


# Method #2 for player
@app_player_api.route('/')
def player_api():
    """obtains all Users from table and loads Admin Form"""
    return render_template("player_async.html", table=users_all())
...
def api_tester():
    ...
    url = 'http://localhost:5222/player_api'
